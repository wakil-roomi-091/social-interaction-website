...
import VideoLightbox from '../common/VideoLightbox';

const PostCard = ({ post, onLikeUpdate, onCommentUpdate, onDelete, onSaveUpdate, onPostUpdate }) => {
    ...
    const isVideo = post.image?.match(/\.(mp4|mov|avi|mkv|webm|wmv)$/i) ||
    ...
    const handleLike = async () => {
        ...
        try {
            ...
            onLikeUpdate?.(post._id, updatedPost);
        } catch (error) {
            setLiked(wasLiked);
            setLikesCount(wasLiked ? likesCount + 1 : likesCount - 1);
    ...
    const handleCommentSubmit = async (e) => {
        ...
        try {
            ...
            onCommentUpdate?.(post._id, updatedPost);
        ...
        <>
            <div className="bg-paper border border-[#1C1B19]/[0.12] rounded-lg overflow-hidden">
                ...
                <div className="p-4 flex items-center gap-3 relative">
                    ...
                    >
                        <img
                            src={post.user?.avatar || 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&h=100&fit=crop&crop=faces'}
                            alt=""
